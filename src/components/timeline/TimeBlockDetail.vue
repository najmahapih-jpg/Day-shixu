  ...
  <view v-if="visible" class="sheet-mask" @tap="emit('close')">
    <view class="sheet" @tap.stop>
      ...
      <view class="sheet__status">
        ...
        <text v-if="streakCurrent > 0" class="sheet__streak">· 连续 {{ streakCurrent }} 天</text>
      </view>
...
.sheet {
  ...
  &__dot {
    ...
    border-radius: $radius-full;
    background: $neutral-300;
    transition: transform $duration-fast $ease-out-soft, background $duration-fast $ease-out-soft;
